...
function show() {
    ...
    var html = '<ul>';
    // this dispays a task to the list in the order that it is imputed
    ...
    // this tells the browser how to dispay the todo aray after an item has been removed
...
function remove() {
    ...
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
    // this looks in the show() how to dispay a removed item on the screen
    show() 
